...
<div class="row-fluid<?php echo $moduleclass_sfx; ?>">
    ...
    {
        ?>
        <div class="ip-recentviewed-holder span<?php echo $rowspan; ?>">
            <?php if($iplayout == 'rows') echo '<div class="span3">'; ?>
                <div class="ip-mod-thumb ip-recentviewed-thumb-holder">
                    <?php echo ipropertyHTML::getThumbnail($item->id, $item->proplink, $item->street_address, '', 'class="ip-recentviewed-thumb thumbnail"', '', $usethumb); ?>
            ...
            ?>
            <div class="ip-mod-desc ip-recentviewed-desc-holder span9">
