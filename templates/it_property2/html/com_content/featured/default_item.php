...
<?php $useDefList = (($params->get('show_modify_date')) or ($params->get('show_publish_date')) or ($params->get('show_author')) or ($params->get('show_hits'))); ?>
	...
	<div class="pull-<?php echo htmlspecialchars($imgfloat); ?> item-image"><a href="<?php echo $link; ?>"> <img
