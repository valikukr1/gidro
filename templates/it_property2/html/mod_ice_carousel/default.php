...
$icecarousel_caption_height = $params->get('main_height',"160");
...
.icecarousel-caption { width: <?php echo $icecarousel_caption_width; ?>px; height:<?php echo $icecarousel_caption_height; ?>px}
