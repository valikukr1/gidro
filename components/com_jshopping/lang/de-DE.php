...
define('_JSHOP_ORDER_STATUS_CHANGE_SUBJECT','Bestellstatus ändern. Bestellung No. %s');
define('_JSHOP_ORDER_STATUS_CHANGE_TITLE', 'Status Änderung');
define('_JSHOP_YOUR_ORDER_STATUS_CHANGE', 'Status Ihrer Bestellung No. %s wurde geändert');
...
define('_JSHOP_PAYMENT_INFORMATION', 'Information der Zahlung');
define('_JSHOP_SHIPPING_INFORMATION', 'Information der Lieferung');
...
define('_JSHOP_NEW_PASSWORD', 'Das neue Passwort');
define('_JSHOP_NEW_PASSWORD_2', 'Das neue Passwort bestätigen');
...
define('_JSHOP_NEW_COMMENT', 'Neu Kommentar');
