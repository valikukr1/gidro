...
(function ($) {
	...
	*/
	function _getWindowDimension(dim) {
		...
		var clientDim = 'client'+Dim;
		var
			bvalue = body[clientDim],                      // has a (maybe incorrect) nonzero value for all major browsers
			dvalue = document.documentElement[clientDim],  // might have a (correct) value
		...
		return Math.min(bvalue, dvalue, wvalue, $(window)[dim]());
	}
